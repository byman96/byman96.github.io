body {background: url("https://i.ibb.co/fNYnhQf/arbre-7.png") fixed;background-repeat: no-repeat;background-size: cover;color: #000;}
...
background: rgba(218, 225, 209, 0.21);
color: #000;
...
.topbar {
background: rgba(218, 225, 209, 0.70);
border: 1px solid #000;
...
.badge {
background: rgba(242, 245, 226, 0.21);
border: 1px solid #000;
}
